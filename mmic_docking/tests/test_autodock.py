...
dockRawInput = DockingRawInput(ligand='CCC', receptor='mmic_docking/data/dialanine/dialanine.pdb')

# Import components
from mmic_docking.components.autodock.autodock_convert_component import ConvertAutoDockComponent
